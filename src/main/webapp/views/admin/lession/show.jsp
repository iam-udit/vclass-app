    ...
    <div class="container-fluid" style="overflow-y: hidden">
		...
		<div id="index"  class="shadow-lg p-4 mb-3 mr-5 bg-white rounded"> 
			...
			<div class="head">
				...
				<% if (!lession.isApproved()) { %>
					<form action="<%= request.getContextPath() + "/admin/lession/approve" %>"
							style="position: absolute; right: 50px; top: 110px ">
					
						<input type="hidden" name="slug" value="<%= lession.getSlug() %>">
						<button type="submit" class="btn-outline-success" title="Approve" formmethod="post" 
